...
echo "<script>window.location.href ='../../Controller/Patient/user-login.php'</script>";
}
	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../../View/index.html"><h2> HMS | Patient Reset Password</h2></a>
				</div>
...
<i class="fa fa-lock"></i> </span>
							...
							<div class="new-account">
								...
								<a href="../../Controller/Patient/user-login.php">
									Log-in
								</a>
							</div>
						</fieldset>
