...
<li>
								<a href="../../View/Admin/appointment-history.php">
									<div class="item-content">
										<div class="item-media">
											<i class="ti-file"></i>
										</div>
				...
				<li>
								...
								<ul class="sub-menu">
									...
									<li>
										<a href="../../View/Admin/unread-queries.php">
											<span class="title"> Unread Query </span>
										</a>
									</li>

									<li>
										<a href="../../View/Admin/read-query.php">
	...
	<li>
								<a href="../../View/Admin/doctor-logs.php">
									<div class="item-content">
										<div class="item-media">
											<i class="ti-list"></i>
										</div>
							...
							<li>
								<a href="../../View/Admin/user-logs.php">
									<div class="item-content">
										<div class="item-media">
											<i class="ti-list"></i>
										</div>
				...
				<li>
								...
								<ul class="sub-menu">
									...
									<li>
										<a href="../../View/Admin/between-dates-reports.php">
								...
								<li>
								<a href="../../Controller/Admin/patient-search.php">
									<div class="item-content">
										<div class="item-media">
											<i class="ti-search"></i>
										</div>
